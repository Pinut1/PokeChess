    ...
    public static class HexUtil2D
    {
        ...
        public static Vector3[] GetCorners(Vector3 origin, float innerRadius, float outerRadius)
        {
            var corners = new Vector3[]
            {
                ...
                new Vector3(innerRadius, .5f * outerRadius, 0) + origin,
                new Vector3(innerRadius, -.5f * outerRadius, 0) + origin,
                new Vector3(0, -outerRadius, 0) + origin,
                new Vector3(-innerRadius, -.5f * outerRadius, 0) + origin,
                new Vector3(-innerRadius, .5f * outerRadius, 0) + origin
        ...
        {
            float xPos = (hexPosition.x + hexPosition.y * .5f - hexPosition.y / 2) * (innerRadius * 2);
        ...
        {
            float xPos = (hexPosition.x + hexPosition.y * .5f - hexPosition.y / 2) * (innerRadius * 2) + innerRadius;
            float yPos = hexPosition.y * (outerRadius * 1.5f);
            float zPos = 0f;
