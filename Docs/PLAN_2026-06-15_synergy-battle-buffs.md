...
> 🔁 **갱신됨 (2026-06-25)**: 기획 CSV 도착 + v9 스탯모델 변경으로 아래 일부가 낡음(특공/특방 폐지,
> 미러매치→PVE). 최신 스키마/매핑은 **[HANDOFF_2026-06-25_synergy-effect-schema.md](HANDOFF_2026-06-25_synergy-effect-schema.md)** 참조. 이 문서는 단계/검증 절차 참고용으로만 유지.
